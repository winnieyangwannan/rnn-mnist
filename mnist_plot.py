...
root_dir = './data/mnist'
model_dir = root_dir + '/10rnn_20dt_1stim_1res_end_20ep'
save_dir = './figure/mnist/10rnn_20dt_1stim_1res_end_20ep/'
tools.mkdir_p(save_dir)

# # Performance Analysis-----------------------------------------------------

#performance.plot_performanceprogress_mnist(model_dir, save_dir=save_dir, rule_plot=['mnist'], type='average')
...
#standard_analysis.plot_connectivity(model_dir=model_dir, save_dir=save_dir)

standard_analysis.plot_activity_pca(model_dir, save_dir)
